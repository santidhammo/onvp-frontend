...
@Component({
  selector: 'config-remove-parent-page',
  standalone: true,
  imports: [
    AsyncPipe,
    BodyComponent,
  ...
  templateUrl: './remove-parent-page.component.html',
  styles: ``,
})
export class RemoveParentPageComponent implements OnInit {
    ...
    if (submitter.name !== 'cancel') {
      ...
      if (lastId) {
        this.pageCommandService
          .setOrUnsetParentPage(lastId, null)
